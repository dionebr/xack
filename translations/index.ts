...
export const translations = {
    en: {
        ...
        machines: {
            ...
            subtitle: "Access restricted environments. Hack responsibly.",
        ...
        machineDetail: {
            loading: "Initializing Mission Interface...",
            notFound: "Mission Not Found.",
            mission: "MISSION",
            difficultyGauge: "Difficulty Gauge",
            estTime: "Est. Mission Time",
            objectives: "Mission Objectives",
            userCompromise: "User Compromise",
            userDesc: "Gain low-privileged access",
            rootEscalation: "Root Escalation",
            rootDesc: "Infiltrate the kernel/admin",
            attackSurface: "Attack Surface Analysis",
            scanningLive: "SCANNING LIVE...",
            deepScan: "Deep Scan Intelligence",
            osFingerprint: "OS Fingerprint",
            webServer: "Web Server",
            middleware: "Middleware",
            kernel: "Kernel",
            blindSpot: "BLIND SPOT ENGAGED",
            blindDesc: "You are operating in a zero-knowledge BLACK BOX environment. Initial recon vectors are masked to simulate realistic blind pentesting conditions.",
            bypassFirewall: "BYPASS FIREWALL",
            attemptChallenge: "Attempt Challenge or Purchase Intel",
            ...
            targetIp: "Target IP",
            downloadVpn: "Download VPN Config",
            loginVpn: "Log in to download VPN",
            officialWriteup: "Official Writeup",
            accessDenied: "ACCESS DENIED",
            accessGranted: "ACCESS GRANTED",
            missionIncomplete: "MISSION INCOMPLETE: Capture Root Flag to unlock Intelligence Report.",
            exfiltrateFlag: "Validate Flag",
            submitCapture: "Validate Flag",
            verifying: "Verifying flag hash...",
            coinsEarned: "X-COINS EARNED!",
            authRequired: "Authentication required.",
            failedStart: "Failed to start mission environment.",
            poc: {
                title: "POC VALIDATION",
                subtitle: "Demonstrate your reconnaissance skills to unlock attack surface details",
                questionLabel: "Question",
                answerPlaceholder: "Enter your answer...",
                validate: "Validate Answer",
                correct: "Correct!",
                incorrect: "Incorrect. Keep investigating...",
                progress: "Progress",
                unlockSuccess: "PoC Validated! Attack surface unlocked.",
                hint: "Show Hint",
                hintCost: "Cost: 10 X-COINS"
            }
        },
        community: {
            title: "Communities",
    ...
    pt: {
        ...
        machines: {
            title: "LABORATÓRIOS DE DESAFIO",
            subtitle: "Acesse ambientes restritos. Hackeie com responsabilidade.",
            totalTargets: "Total de Alvos",
            searchPlaceholder: "Buscar desafios...",
            deploy: "Implantar",
            points: "PTS",
            loading: "CARREGANDO DESAFIOS...",
            noResults: "Nenhum Desafio Encontrado",
            noResultsDesc: "Tente selecionar uma categoria diferente.",
            difficulty: {
                easy: "fácil",
                medium: "médio",
                hard: "difícil"
        ...
        machineDetail: {
            loading: "Inicializando Interface da Missão...",
            notFound: "Missão Não Encontrada.",
            mission: "MISSÃO",
            difficultyGauge: "Dificuldade",
            estTime: "Tempo Estimado",
            objectives: "Objetivos da Missão",
            userCompromise: "Acesso Inicial",
            userDesc: "Obter acesso com baixo privilégio",
            rootEscalation: "Escalação Root",
            rootDesc: "Infiltrar o kernel/admin",
            attackSurface: "Superfície de Ataque",
            scanningLive: "ESCANEANDO AO VIVO...",
            deepScan: "Varredura Profunda",
            osFingerprint: "SO Detectado",
            webServer: "Servidor Web",
            middleware: "Middleware",
            kernel: "Kernel",
            blindSpot: "PONTO CEGO ATIVADO",
            blindDesc: "Você está operando em um ambiente BLACK BOX de conhecimento zero. Vetores de reconhecimento inicial estão mascarados para simular condições realistas de pentest cego.",
            bypassFirewall: "BURLAR FIREWALL",
            attemptChallenge: "Tentar Desafio ou Comprar Intel",
            missionControl: "Controle da Missão",
            initEnv: "Inicializar Ambiente",
            terminate: "Terminar",
            reload: "Recarregar",
            booting: "Iniciando SO...",
            syncing: "Sincronizando Dados...",
            targetIp: "IP do Alvo",
            downloadVpn: "Baixar Config VPN",
            loginVpn: "Faça login para baixar VPN",
            officialWriteup: "Writeup Oficial",
            accessDenied: "ACESSO NEGADO",
            accessGranted: "ACESSO CONCEDIDO",
            missionIncomplete: "MISSÃO INCOMPLETA: Capture a Flag Root para desbloquear o Relatório de Inteligência.",
            exfiltrateFlag: "Validar Flag",
            submitCapture: "Validar Flag",
            verifying: "Verificando hash da flag...",
            coinsEarned: "X-COINS GANHOS",
            authRequired: "Autenticação necessária.",
            failedStart: "Falha ao iniciar ambiente da missão.",
            poc: {
                title: "VALIDAÇÃO POC",
                subtitle: "Demonstre suas habilidades de reconhecimento para desbloquear detalhes da superfície de ataque",
                questionLabel: "Questão",
                answerPlaceholder: "Digite sua resposta...",
                validate: "Validar Resposta",
                correct: "Correto!",
                incorrect: "Incorreto. Continue investigando...",
                progress: "Progresso",
                unlockSuccess: "PoC Validada! Superfície de ataque desbloqueada.",
                hint: "Mostrar Dica",
                hintCost: "Custo: 10 X-COINS"
            }
        },
        community: {
            title: "Comunidades",
