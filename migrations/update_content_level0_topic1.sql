...
graph TD
    ...
    B -->|Drivers| C[Hardware (CPU/RAM/Disk)]
    style B fill:#f9f,stroke:#333,stroke-width:2px
```
*(Diagram: Flow of Control)*

If a villager (Chrome.exe) wants to touch the treasure (draw on screen), they **must** ask the King (Kernel). They cannot do it themselves.
